...
TAREAS_POR_ETAPA = {
    ...
    # aplica_cantidad: False → tarea administrativa/gestión, no consume m²/ml/m³
    'Preliminares y Obrador': [
        {'nombre': 'Gestión de permisos municipales', 'descripcion': 'Tramitar permiso de obra y cartel de obra', 'horas': 8, 'aplica_cantidad': False},
        {'nombre': 'Armar obrador', 'descripcion': 'Instalar oficina, vestuario y sanitario de obra', 'horas': 16},
        {'nombre': 'Cerco perimetral de obra', 'descripcion': 'Colocar vallado provisorio en todo el perímetro', 'horas': 8},
        ...
        {'nombre': 'Replanteo general', 'descripcion': 'Marcar ejes, niveles y líneas de edificación', 'horas': 10},
        {'nombre': 'Cartel de obra', 'descripcion': 'Colocar cartel reglamentario en frente de obra', 'horas': 2, 'aplica_cantidad': False},
        {'nombre': 'Plan de seguridad e higiene', 'descripcion': 'Elaborar y presentar plan de SyH ante ART', 'horas': 8, 'aplica_cantidad': False},
        {'nombre': 'Relevamiento topográfico', 'descripcion': 'Realizar planialtimetría del terreno', 'horas': 6, 'si_aplica': True, 'aplica_cantidad': False},
        ...
        {'nombre': 'Verificación de medianeras', 'descripcion': 'Constatar estado y altura de muros linderos', 'horas': 4, 'aplica_cantidad': False},
        {'nombre': 'Registro fotográfico inicial', 'descripcion': 'Documentar estado previo del terreno y linderos', 'horas': 2, 'aplica_cantidad': False},
    ],

    'Demoliciones': [
        {'nombre': 'Relevamiento de estructuras a demoler', 'descripcion': 'Identificar elementos a demoler según proyecto', 'horas': 4, 'aplica_cantidad': False},
        ...
        {'nombre': 'Clasificación de escombros', 'descripcion': 'Separar material reutilizable del descarte', 'horas': 4, 'aplica_cantidad': False},
    ...
    'Movimiento de Suelos': [
        ...
        {'nombre': 'Control de compactación (Proctor)', 'descripcion': 'Realizar ensayo de densidad en capas', 'horas': 4, 'si_aplica': True, 'aplica_cantidad': False},
    ...
    'Apuntalamientos': [
        ...
        {'nombre': 'Control de deformaciones', 'descripcion': 'Monitorear movimientos con testigos y niveles', 'horas': 4, 'si_aplica': True, 'aplica_cantidad': False},
    ...
    'Depresión de Napa / Bombeo': [
        {'nombre': 'Estudio de nivel freático', 'descripcion': 'Determinar profundidad de napa mediante cateos', 'horas': 6, 'si_aplica': True, 'aplica_cantidad': False},
    ...
    'Ventilaciones y Conductos': [
        ...
        {'nombre': 'Verificación de tiro', 'descripcion': 'Probar tiraje con humo en cada conducto', 'horas': 2, 'aplica_cantidad': False},
    ...
    'Excavación': [
        ...
        {'nombre': 'Verificación de niveles según planos', 'descripcion': 'Control topográfico y verificación de cotas según documentación técnica', 'horas': 2, 'aplica_cantidad': False},
        ...
        {'nombre': 'Estudio de suelos', 'descripcion': 'Análisis del suelo para determinar características y capacidad portante', 'horas': 8, 'aplica_cantidad': False},
        {'nombre': 'Verificación de medianeras', 'descripcion': 'Control y verificación de límites del terreno con propiedades lindantes', 'horas': 2, 'aplica_cantidad': False},
    ...
    'Fundaciones': [
        ...
        {'nombre': 'Verificación de niveles y plomadas', 'descripcion': 'Control topográfico de niveles y verticalidad', 'horas': 4, 'aplica_cantidad': False},
        ...
        {'nombre': 'Control de resistencia hormigón', 'descripcion': 'Toma de muestras y control de resistencia', 'horas': 2, 'aplica_cantidad': False},
        # --- Tareas nuevas ---
    ...
    'Estructura': [
        ...
        {'nombre': 'Verificación estructural', 'descripcion': 'Control de calidad y verificación estructural', 'horas': 4, 'aplica_cantidad': False},
        ...
        {'nombre': 'Control de calidad del hormigón', 'descripcion': 'Ensayos y controles de calidad del hormigón', 'horas': 4, 'aplica_cantidad': False},
        ...
        {'nombre': 'Control de juntas de hormigonado', 'descripcion': 'Verificar y tratar juntas frías entre etapas', 'horas': 4, 'aplica_cantidad': False},
        {'nombre': 'Despiece por piso / sector', 'descripcion': 'Planificar y ejecutar hormigonado por sectores', 'horas': 8, 'si_aplica': True, 'aplica_cantidad': False},
    ...
    'Mampostería': [
        ...
        {'nombre': 'Verificación de aplomes y niveles', 'descripcion': 'Control de verticalidad y horizontalidad de muros', 'horas': 2, 'aplica_cantidad': False},
        ...
        {'nombre': 'Control de calidad mampostería', 'descripcion': 'Verificación final de calidad y terminación', 'horas': 2, 'aplica_cantidad': False},
        {'nombre': 'Protección temporal', 'descripcion': 'Protección de muros nuevos contra intemperie', 'horas': 2, 'aplica_cantidad': False},
        # --- Tareas nuevas ---
    ...
    'Techos': [
        ...
        {'nombre': 'Control de calidad cubierta', 'descripcion': 'Verificación final de estanqueidad', 'horas': 2, 'aplica_cantidad': False},
        # --- Tareas nuevas ---
    ...
    'Instalaciones Eléctricas': [
        ...
        {'nombre': 'Pruebas y puesta en marcha', 'descripcion': 'Ensayos eléctricos y puesta en servicio', 'horas': 6, 'aplica_cantidad': False},
        ...
        {'nombre': 'Medición y verificación', 'descripcion': 'Medición de resistencias y continuidad', 'horas': 4, 'aplica_cantidad': False},
        {'nombre': 'Protecciones eléctricas', 'descripcion': 'Instalación de disyuntores y protectores', 'horas': 4},
        {'nombre': 'Documentación eléctrica', 'descripcion': 'Elaboración de planos finales as-built', 'horas': 2, 'aplica_cantidad': False},
        # --- Tareas nuevas ---
    ...
    'Instalaciones Sanitarias': [
        ...
        {'nombre': 'Prueba de estanqueidad', 'descripcion': 'Pruebas de presión y hermeticidad del sistema', 'horas': 4, 'aplica_cantidad': False},
    ...
    'Instalaciones de Gas': [
        ...
        {'nombre': 'Prueba de hermeticidad', 'descripcion': 'Pruebas de presión y detección de fugas', 'horas': 6, 'aplica_cantidad': False},
        ...
        {'nombre': 'Habilitación con empresa gasífera', 'descripcion': 'Trámites y habilitación oficial', 'horas': 4, 'aplica_cantidad': False},
        {'nombre': 'Verificación de ventilaciones', 'descripcion': 'Control de ventilaciones según normativa', 'horas': 2, 'aplica_cantidad': False},
        # --- Tareas nuevas ---
    ...
    'Revoque Grueso': [
        ...
        {'nombre': 'Verificación de verticalidad', 'descripcion': 'Control de plomadas y niveles', 'horas': 4, 'aplica_cantidad': False},
        # --- Tareas nuevas ---
    ...
    'Pintura': [
        ...
        {'nombre': 'Revisión y retoques finales', 'descripcion': 'Inspección final y corrección de detalles', 'horas': 6, 'aplica_cantidad': False},
    ...
    'Instalaciones Complementarias': [
        ...
        {'nombre': 'Configuración domótica', 'descripcion': 'Programación de sistemas inteligentes', 'horas': 8, 'aplica_cantidad': False},
        # --- Tareas nuevas ---
    ...
    'Limpieza Final': [
        ...
        {'nombre': 'Entrega de documentación', 'descripcion': 'Preparación de documentación de entrega', 'horas': 2, 'aplica_cantidad': False},
        {'nombre': 'Inspección final', 'descripcion': 'Inspección final y lista de pendientes', 'horas': 4, 'aplica_cantidad': False},
        # --- Tareas nuevas ---
        ...
        {'nombre': 'Checklist de entrega final', 'descripcion': 'Verificar terminaciones y funcionamiento general', 'horas': 4, 'aplica_cantidad': False},
        {'nombre': 'Confección de manual de usuario', 'descripcion': 'Entregar manual con instrucciones de uso y garantías', 'horas': 4, 'si_aplica': True, 'aplica_cantidad': False},
    ],
}
